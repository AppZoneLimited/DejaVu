 ...
 */
public class DJV_TextArea extends LinearLayout {
    ...
    public DJV_TextArea(Context context, AttributeSet attrs, int defStyleAttr, UI_Object ui_object) {
    ...
    private void initialise() {
        ...
        inflater.inflate(R.layout.djv_textarea, this);
